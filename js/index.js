...
(function () {
  var fivedata = {
    today: [
      { name: "冯绍峰谈到儿子眼圈红了", num: "9,086" },
      { name: "郑爽若故意隐瞒转移财产或被判刑3年", num: "8,341" },
      { name: "七年雄安拔节生长", num: "7,407" },
      { name: "全新腾势N7上市", num: "6,080" },
      { name: "赵丽颖受刑戏又有钉子", num: "6,724" },
      { name: "6个月婴儿雨夜爬上马路被接力守护", num: "2,170" },
    ],
    yesterday: [
      { name: "玄彬孙艺珍出演眼泪女王", num: "10,316" },
      { name: "追风者阿文跳楼", num: "9,141" },
      { name: "王腾回应红米汽车", num: "7,437" },
      { name: "雷军恳请各位口下留情", num: "5,312" },
      { name: "新疆成为包邮区", num: "4,313" },
      { name: "女子睡觉被大风吹下11楼身亡", num: "3.123" },
    ],
    daybefore: [
      { name: "为什么无性婚姻越来越多", num: "11,086" },
      { name: "邓为站姐发了EXO", num: "10,331" },
      { name: "汪苏泷郁可唯互发自拍", num: "9,313" },
      { name: "朋友整个孕期抽了48管血", num: "9,111" },
      { name: "上海一轿车失控撞飞多名路人", num: "5,431" },
      { name: "物业回应南昌一小区窗框吹落3人坠亡", num: "4,321" },
    ],
    daybefore2: [
      { name: "宋昰昀被曝校园暴力", num: "9,633" },
      { name: "白鹿簪花妆", num: "8,412" },
      { name: "杨幂好用心", num: "7,407" },
      { name: "酒店拖鞋上这个洞有什么用", num: "6,312" },
      { name: "这居然是罗云熙", num: "3,321" },
      { name: "罗伯特头像", num: "1,323" },
    ],
    daybefore3: [
      { name: "WBG对战iG", num: "9,021" },
      { name: "七宝街 我哭死", num: "7,341" },
      { name: "存了12万被妈妈一年花完了", num: "6,437" },
      { name: "爸爸用排烟管给女儿做了一条粉色龙", num: "6,310" },
      { name: "张大大在天水麻辣烫店当服务员", num: "5,710" },
      { name: "南昌天气", num: "3,170" },
    ],
  };
